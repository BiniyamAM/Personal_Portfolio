      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            Turning ideas into scalable, user-friendly solutions with modern technologies.
          </motion.p>
          ...
          >
            <Button 
              size="lg" 
              className="group shadow-glow hover:scale-105 transition-smooth"
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 hover:scale-105 transition-smooth"
